...
public class TrainUserListAdapter extends ArrayAdapter<UserInfo> {
	...
	public TrainUserListAdapter(Context context, int resource, List<UserInfo> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.item_train_user, null);
        ...
        //viewCache.sexType;
        viewCache.userType.setText(user.user_type);
